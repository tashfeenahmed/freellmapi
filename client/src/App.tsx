...
function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className={`flex flex-col ${fullBleed ? 'h-dvh overflow-hidden' : 'min-h-screen min-w-0 max-w-full overflow-x-hidden'} ${isMacDesktop ? 'desktop-backdrop' : 'bg-background'}`}>
