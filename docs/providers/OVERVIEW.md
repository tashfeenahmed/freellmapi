...
The authoritative sources are [`shared/types.ts`](../../shared/types.ts) (the `Platform` union), [`server/src/providers/index.ts`](../../server/src/providers/index.ts) (the runtime registry), and [`server/src/providers/base.ts`](../../server/src/providers/base.ts) (the adapter contract). The public catalog headline — roughly 29 free providers, 251 model families, 358 free endpoints (~4 billion tokens/month of listed capacity) — comes from the [provider table in the README](../../README.md); the catalog itself tracks fewer platforms than the type union declares because some union members are retired or user-defined rather than catalog-managed.
